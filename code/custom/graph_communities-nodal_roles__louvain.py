...
# Define input corrmat files and output directory.
CORRMAT_GLOB_FPT = '/home/despoB/DistractWM/data/derivatives/custom/sub-{0}/func/sub-{0}_task-*_bold_space-MNI152NLin2009cAsym_atlas-BNA_variant-Motion24CompCor_corrmat.npy'
    ...
    if sub_id not in skip_list:
        try:
            ...
            for corrmat_npy in corrmat_files:
                print('...Scan: {0}...'.format(os.path.basename(corrmat_npy)))
